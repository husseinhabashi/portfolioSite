...
export default function MainPage() {
  ...
  const TIMING = {
    ...
    disableDim: true, // keep true so dim cycle doesn’t overlap pulse
  }
      ...
      {!fastload && shieldFullyVisible && !showDashboard && !showHeader && (
        ...
        >
          ...
          >
            ...
            {/* Line 2 (placeholder reserves space until start) */}
            <span
              className="inline-block text-xs sm:text-base align-top"
              style={{
          ...
          {/* Bottom banner: sequential, consistent font on mobile */}
          {showBottom && (
            <div
